  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[rgba(255,255,255,0.86)] backdrop-blur-xl supports-[backdrop-filter]:bg-[rgba(255,255,255,0.78)]">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <a
          href="#pocetna"
          onClick={(e) => handleAnchorClick(e, "#pocetna")}
        ...
        >
          <div className="flex items-center gap-2.5">
            <Image src="/brand/makai-ika-crna.svg" width={38} height={42} alt="Maka i Ika – domaća kuhinja" className="h-9 w-auto shrink-0" />
            <span className="min-w-0">
              <span className="block truncate text-base font-semibold tracking-tight text-[#1f1f1c] sm:text-[20px]">Maka i Ika</span>
              <span className="block truncate text-[11px] text-[#5a5a55] sm:text-xs">Domaća kuhinja · Banovo brdo</span>
            </span>
          </div>
        </a>
