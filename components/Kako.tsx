...
const steps: StepItem[] = [
  {
    num: "1",
    title: "Pogledajte dnevni meni",
    desc: "Svaki radni dan pogledajte šta kuvamo i proverite dostupnost pre dolaska.",
    Icon: ClipboardList,
  },
  {
    num: "2",
    title: "Poručite kako vam odgovara",
    desc: "Pozovite nas, pišite na WhatsApp ili poručite preko Wolt i Glovo platformi.",
    Icon: UtensilsCrossed,
  },
  {
    num: "3",
    title: "Preuzmite ili dogovorite isporuku",
    desc: "Lično preuzimanje je u Požeškoj 78, a za firme se unapred dogovaramo o isporuci.",
    Icon: Truck,
  },
];
    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[#1f1f1c] sm:text-4xl lg:text-5xl">
          Domaći ručak bez komplikacija
        </h2>

        <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-[#5f5f59] sm:text-lg">
          Kuvamo u ograničenim količinama, zato je najlepše da pre poručivanja proverite šta je danas dostupno.
        </p>
      </div>
